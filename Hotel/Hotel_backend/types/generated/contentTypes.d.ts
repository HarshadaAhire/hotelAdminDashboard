...
export interface ApiBookingBooking extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    roomFacility: Schema.Attribute.Text;
    bookDate: Schema.Attribute.Date;
    roomFloor: Schema.Attribute.String;
...
export interface ApiEmployeeEmployee extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    empStatus: Schema.Attribute.Enumeration<['Active', 'Inactive']>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiGuestGuest extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    dateOrder: Schema.Attribute.Date;
    timeOrder: Schema.Attribute.Time;
    checkIn: Schema.Attribute.Date;
    checkOut: Schema.Attribute.Date;
    timeCheckOut: Schema.Attribute.Time;
    timeCheckIn: Schema.Attribute.Time;
    image: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    guestStatus: Schema.Attribute.Enumeration<
      ['pending ', 'Booked', 'Canceled ', 'Refund']
    >;
...
export interface ApiRoomRoom extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    bookingId: Schema.Attribute.BigInteger;
    ...
    bedType: Schema.Attribute.String;
    roomNumber: Schema.Attribute.String;
    availableDates: Schema.Attribute.Date;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
